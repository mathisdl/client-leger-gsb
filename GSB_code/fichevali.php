    ...
    <body>
        ...
        <!-- This code is taken from http://twitter.github.com/bootstrap/examples/hero.html -->
            ...
            <div class="menu">
                <div class="navbar">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                            <li class="active border-left"><a href="comptable.php">Liste fiche</a></li>
            ...
            <?php
                ...
                $query = "SELECT * FROM fichefrais ORDER by mois";
                ...
                while($row = $result->fetch_array())
                {
                    ...
                    echo "<td> <a href='fichevali.php?id=".$row['id']."' > Voir</a> </td>";
                    echo "</tr>";
                }
            ?>
                </table>

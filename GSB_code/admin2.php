...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <fieldset>
            ...
            <input id="id" name="id" type="text" value="" size="15" maxlength="13"/>
            <br />
            <label for="nom">Nom: </label>
            <input id="nom" name="nom" type="text" value="" size="10" maxlength="8"/>
            <br />
            <label for="prenom">Prenom : </label>
            <input id="prenom" name="prenom" type="text" value="" size="10" maxlength="8"/>
            <br />
            <label for="adresse">Adresse : </label>
            <input id="adresse" name="adresse" type="text" value="" size="20" maxlength="18"/>
            <br />
            <label for="cp">Code Postal : </label>
            <input id="cp" name="cp" type="number" value="" size="7" maxlength="5"/>
            <br />
            <label for="ville">Ville : </label>
            <input id="ville" name="ville" type="text" value="" size="15" maxlength="13"/>
            <br />
            <label for="Date">Date Embauche : </label>
            <input id="Date" name="date" type="date" value="" size="15" maxlength="13"/>
            <br />
            <label for="login">Login : </label>
            <input id="login" name="login" type="text" value="" size="15" maxlength="13"/>
            <br />
            <label for="password">Password : </label>
            <input id="password" name="password" type="password" value="" size="15" maxlength="13"/>
            <br />
        </fieldset>
        ...
        <p>
            <input  type="button"  name="btnannul" value="Annuler" onclick="self.location.href='admin2.php'" />

    ...
    <body>
        ...
        <!-- This code is taken from http://twitter.github.com/bootstrap/examples/hero.html -->
            ...
            <div class="contenu1">
                ...
                <form id="formulaire" action="comptinsert.php" method="get">
        ...
        <fieldset>
            ...
            <input id="libelle" name="libelle" type="text" value="" size="27" maxlength="25"/>
            <br />
            <label for="montant">Montant : </label>
            <input id="montant" name="montant" type="number" value="" size="10" maxlength="8"/>
            <br />

    ...
    <body>
        ...
        <!-- This code is taken from http://twitter.github.com/bootstrap/examples/hero.html -->
            ...
            <?php
                ...
                ?>
                <form id="formulaire" action="updatecompt.php" method="get">

        <fieldset>
            <legend>INFORMATION : </legend>

            <label for="id">Id: </label>
            <input id="id" name="id" type="text" value="<?php echo $id; ?>" size="10" maxlength="8"/>
            <br />
            <label for="libelle">libelle : </label>
            <input id="libelle" name="libelle" type="text" value="<?php echo $libelle; ?>" size="10" maxlength="8"/>
            <br />
            <label for="montant">Montant : </label>
            <input id="montant" name="montant" type="number" value="<?php echo $montant; ?>" size="20" maxlength="18"/>
            <br />
        ...
        <p>
            <input  type="button"  name="btnannul" value="Annuler" onclick="self.location.href='comptable2.php'" />
